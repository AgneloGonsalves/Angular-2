System.register([], function(exports_1, context_1) {
    ...
    var InMemorytrackService;
    return {
        setters:[],
        execute: function() {
            InMemorytrackService = (function () {
                function InMemorytrackService() {
                }
                /**
                * Creates fresh copy of data each time.
                * Safe for consuming service to morph arrays and objects.
                */
                InMemorytrackService.prototype.createDb = function () {
                    //let sites = [
                    //  {
                    //    "id": 11,
                    //    "name": "Chewbacca",
                    ...
                    //  }
                    //]
                    return { sites: sites, resources: resources };
                };
                return InMemorytrackService;
            }());
            exports_1("InMemorytrackService", InMemorytrackService);
        }
    }
});
//# sourceMappingURL=in-memory-track.service.js.map